...
> 3. Like: 즐겨찾기수가 가장 높은 상위 3곳의 음식점을 출력해준다.
> 4. Footer: 로그인을 한 사용자가 추천하고 싶은 음식점을 제출하면 관리자가 반영할 수 있도록 DB에 저장한다.
...
> 2. 세션 유효기간: 세션 유효기간을 24시간으로 지정해 세션을 DB에 저장해 24시간동안 로그인이 유지된다.
